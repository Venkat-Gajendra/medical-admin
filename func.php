...
if(isset($_POST['patsub'])){
	...
	$query="select * from patreg where contact='$mobileno' and password='$password';";
...
if(isset($_POST['forgetpass'])){
  ...
  $query = "SELECT * FROM patreg WHERE contact='$mobileno' AND dob='$dob';";
  $result = mysqli_query($con, $query);
  ...
  if(mysqli_num_rows($result) == 1) {
      ...
      $update_query = "UPDATE patreg SET password='$password', cpassword='$password' WHERE pid='$pid';";
      ...
      echo("<script>alert('Invalid Mobile Number or Date of Birth. Try Again!');
            window.location.href = 'index1.php';</script>");
  }
}
