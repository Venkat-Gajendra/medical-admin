...
.col-sm-4{
  ...
  <body style="padding-top:50px;">
   ...
   <div class="container-fluid" style="margin-top:50px;">
    ...
    <div class="row">
  <div id="dashboard"class="col-md-4" style="max-width:25%; margin-top: 3%">
  ...
  <div class="col-md-8" style="margin-top: 3%;">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-4"><label for="doctor">clinic's:</label></div>
                <div class="col-md-8">
                    <select name="doctor" class="form-control" id="doctor" required="required">
                      <option value="" disabled selected>Select clinic's</option>
    ...
    var selection = document.querySelector(`option[value="${this.value}"]`).getAttribute('data-value');
