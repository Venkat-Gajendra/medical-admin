   ...
   <div class="tab-pane" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
        <form class="form-group" name="prescribeform" method="post" action="prescribe.php">
          ...
          <div class="row">
                  ...
                  <br><br><br><br>
          <input id="submitbtn" type="submit" name="prescribe" value="Prescribe" class="btn btn-primary" style="margin-left: 40pc;">
          <!-- <input id="exitbtn" type="submit" name="exit" value="exit" class="btn btn-primary" style="margin-left: 40pc;"> -->
          <input id="exitbtn" type="submit" name="exit" value="exit" class="btn btn-primary" onclick="window.location.href='doctor-panel.php';" style="margin-left: 10px;">
