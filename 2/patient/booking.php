...
<body>
    ...
    $userfetch = $result->fetch_assoc(); // fetch the user row
    $userid = $userfetch["pid"]; // assuming "pid" is the column name for user ID
    $username = $userfetch["pname"]; // assuming "pname" is the column name for user name
