...
@media (max-width: 768px) 
{
    ...
    .register-right {
    background: #f8f9fa;
    border-top-left-radius: 12% 45%;
    border-bottom-left-radius: 34% 118%;
}
    .col-md-9{
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp Best of IDs</h4></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="services.html" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6>SERVICES</h6></a>
          </li>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    ...
                    <img width="70" height="70" src="https://img.icons8.com/ios-filled/50/FFFFFF/handshake-heart.png" alt="handshake-heart"/>
                                        <!-- <img src="https://img.icons8.com/ios/100/000000/handshake-heart.png" alt="handshake-heart"> -->
                        <h3>Welcome</h3>
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="index1.php"style="font-weight: bolder;" class="btn btn-primary btn-login" id="login-link">Login</a>
                                            <!-- <a href="index1.php"><button href="index1.php"id ="login-link" class="btn btn-primary ">login</button></a> -->
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="date" placeholder="YYYY-MM-DD" class="form-control"  id="date"  name="date"  onkeyup='check();' required/>
                                        </div>
                                        <input type="submit" style ="
                                        "class="btnRegister" name="patsub1" onclick="return checklen();" value="Register"/>
                                    </div>
