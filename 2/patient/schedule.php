...
<body>
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" >
                        ...
                        <div class="heading-main12" style="  margin-left: 45px ;font-size:20px;color:rgb(49, 49, 49);margin-top: 60px;">Select a doctor</div>
                        </div>
    ...
    <?php
    include("../connection.php");
    $userrows = $database->query("select * from doctor");
    echo $userrows;
    while ($userfetch=$userrows->fetch_assoc()) {
        $doctorname= $userfetch["docname"];
        echo '
        <div class="row">
            <div class="col-sm-6">
                <div class="card">
